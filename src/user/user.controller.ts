...
export class UserController {
    ...
    @Get('getPosts/:id')
    @UseGuards(AuthGuard)
    async getPosts(@Param('id', ParseIntPipe) id: number): Promise<ArrayResponse<PostDto>>{
    ...
    @Get('getComments/:id')
    @UseGuards(AuthGuard)
    async getComments(@Param('id', ParseIntPipe) id: number): Promise<ArrayResponse<CommentDto>>{
        return mapToArrayResponse(
